#!/bin/bash
#SBATCH -J 002_Incremental_Experiment_2_shaira-odd-gpu
#SBATCH -o 002_Incremental_Experiment_2_shaira-odd-gpu.%j.out
#SBATCH -e 002_Incremental_Experiment_2_shaira-odd-gpu.%j.err
#SBATCH -p gpu-a100
#SBATCH --mem=64G
#SBATCH -N 1
#SBATCH -n 1
...
# --- run experiment ---
cd "$SCRIPT_DIR"
echo "Running main experiment: python 002_Incremental_Experiment_2.py"
srun python 002_Incremental_Experiment_2.py
