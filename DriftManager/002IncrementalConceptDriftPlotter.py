...
def plot_placeholder_drift_lines_anchored(*dicts):
    ...
    #            frameon=False, fontsize=14, bbox_to_anchor=(0.5, 1.01))
...
# ---------- main ----------
def main():
    from DriftManager import IncrementalDriftPlaceholders
    dict_p1 = IncrementalDriftPlaceholders.PLACEHOLDER_VALUES_P1
    dict_p2 = IncrementalDriftPlaceholders.PLACEHOLDER_VALUES_P2
    dict_p3 = IncrementalDriftPlaceholders.PLACEHOLDER_VALUES_P3
    dict_p4 = IncrementalDriftPlaceholders.PLACEHOLDER_VALUES_P4
    dict_p5 = IncrementalDriftPlaceholders.PLACEHOLDER_VALUES_P5
    plot_placeholder_drift_lines_anchored(dict_p1, dict_p2, dict_p3, dict_p4, dict_p5)
